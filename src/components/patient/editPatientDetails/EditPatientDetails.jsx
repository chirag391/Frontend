...
const EditPatientDetails = () => {
    ...
    return (
        <div className='editpatientdetails'>
            <div className='editpatientimage'><img className='editpatientprofileimage' src={`https://doctors-backend-e5w1.onrender.com/` + patientDetails.profile_image} alt='patient'></img></div>
